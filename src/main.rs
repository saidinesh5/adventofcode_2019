...
fn day16() {
    println!("Day 16 result a = {}", day16::process_a(testdata("testdata/day16/input.txt").as_ref(), 100));
    println!("Day 16 result b = {}", day16::process_b(testdata("testdata/day16/input.txt").as_ref(), 100));
}